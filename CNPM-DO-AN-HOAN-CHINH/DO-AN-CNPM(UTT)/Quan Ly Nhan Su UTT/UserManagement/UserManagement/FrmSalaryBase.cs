...
{
    public partial class FrmSalaryBase : Form
    {
        ...
        private void GetDataSalary()
        {
            ...
            {
                GridSalaryBase.DataSource = Extendsion.AllSalaryBase(null);
            }
            else
            {
                GridSalaryBase.DataSource = Extendsion.AllSalaryBase(int.Parse(cbboxDepartmentFilter.SelectedValue.ToString()));
            }
