...
namespace UserManagement
{
    public class Extendsion
    {
        ...
        public static bool ReportCalculationSalary(PaginationUserCaculationSalaryRequest request,string DirectoryPath)
        {

            var data = CalculationSalaryUser(request);
            if (!data.Any())
            {
                return false;
            }
            ...
            using (ExcelPackage package = new ExcelPackage(fileTemp))
            {
                ...
                foreach (var item in data)
                {
                    ...
                    worksheet.Cells["B" + i].Value = item.IdUser;
        ...
        public static bool ReportSalaryProfilesUser(UserDetailSalary model, string DirectoryPath,DateTime StartDate , DateTime EndDate,double RealSalary,double TotalAdvanced,double TotalBonus,double TotalPenalty)
        {
            string appPath = Path.GetDirectoryName(Application.ExecutablePath);
            //D:\UserManagement\UserManagement\UserManagement\bin\Debug\
        ...
        public static List<DateWork> DateWorkByUser(int UserId,DateTime StartDate,DateTime EndDate)
        {
            var tb = new DataTable();
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "GetDateWorkByUser";
        ...
        public static List<Bonus> ListBonusByUser(int UserId, DateTime StartDate, DateTime EndDate)
        {
            var tb = new DataTable();
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "GetBonusByUser";
                cmd.Parameters.Add(new SqlParameter("@Id", UserId));
                cmd.Parameters.Add(new SqlParameter("@StartDate", StartDate));
                cmd.Parameters.Add(new SqlParameter("@EndDate", EndDate));
                SqlDataAdapter Adapter = new SqlDataAdapter(cmd);
        ...
        public static List<SalaryAdvance> ListAdvanceByUser(int UserId, DateTime StartDate, DateTime EndDate)
        {
            var tb = new DataTable();
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "GetAdvanceByUser";
                cmd.Parameters.Add(new SqlParameter("@Id", UserId));
                cmd.Parameters.Add(new SqlParameter("@StartDate", StartDate));
                cmd.Parameters.Add(new SqlParameter("@EndDate", EndDate));
                SqlDataAdapter Adapter = new SqlDataAdapter(cmd);
        ...
        public static List<Penalty> ListPenaltyByUser(int UserId, DateTime StartDate, DateTime EndDate)
        {
            var tb = new DataTable();
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "GetPenaltyByUser";
                cmd.Parameters.Add(new SqlParameter("@Id", UserId));
                cmd.Parameters.Add(new SqlParameter("@StartDate", StartDate));
                cmd.Parameters.Add(new SqlParameter("@EndDate", EndDate));
                SqlDataAdapter Adapter = new SqlDataAdapter(cmd);
        ...
        public static double GetCurrentSalary(int UserId)
        {
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                con.Open();
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "GetCurrentSalaryByUser";
                cmd.Parameters.Add(new SqlParameter("@Id", UserId));
        ...
        public static DataTable GetUserById(int SalaryId)
        {
            var tb = new DataTable();
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
        ...
        public static DataTable GetUserBonusById(int Id)
        {
            var tb = new DataTable();
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "UserBonusGetById";
        ...
        public static DataTable GetUserPenaltyById(int Id)
        {
            var tb = new DataTable();
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "UserPenaltyGetById";
                cmd.Parameters.Add(new SqlParameter("@Id", Id));
                var result = cmd.ExecuteReader();
                tb.Load(result);
                con.Close();
        ...
        public static List<UserViewModel> Users(PaginationUserRequest request)
        {
            var tb = new DataTable();
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
        ...
        public static List<UserCalculationSalaryVm> CalculationSalaryUser(PaginationUserCaculationSalaryRequest request)
        {
            var tb = new DataTable();
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "CalculationSalaryUser";
                cmd.Parameters.Add(new SqlParameter("@pageIndex", request.pageIndex));
                cmd.Parameters.Add(new SqlParameter("@pageSize", request.pageSize));
                if (request.DepartmentId == null)
                {
            ...
            List<UserCalculationSalaryVm> ResultList = new List<UserCalculationSalaryVm>();
            for (int i = 0; i < tb.Rows.Count; i++)
            {
                UserCalculationSalaryVm item = new UserCalculationSalaryVm();
                item.IdUser = Convert.ToInt32(tb.Rows[i]["IdUser"]);
                item.FullName = tb.Rows[i]["FullName"].ToString();
        ...
        public static List<DepartmentVm> Departments()
        {
            ...
            for (int i = 0; i < tb.Rows.Count; i++)
            {
                ...
                item.IsUnit = (bool)tb.Rows[i]["IsUnit"];
                ResultList.Add(item);
            }
            return ResultList;
        }
        ...
        public static List<UserBonusViewModel> UserBonusAll(PaginationUserBonusRequest request)
        {
            var tb = new DataTable();
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
            ...
            List<UserBonusViewModel> ResultList = new List<UserBonusViewModel>();
            for (int i = 0; i < tb.Rows.Count; i++)
            {
                UserBonusViewModel item = new UserBonusViewModel();
                item.Id = Convert.ToInt32(tb.Rows[i]["Id"]);
                item.UserId = Convert.ToInt32(tb.Rows[i]["UserId"]);
                item.FullName = tb.Rows[i]["FullName"].ToString();
                item.DepartmentName = tb.Rows[i]["DepartmentName"].ToString();
                item.DateBonus = (DateTime)tb.Rows[i]["DateBonus"];
        ...
        public static List<UserAdvanceSalaryViewModel> SalaryAdvanceAll(PaginationSalaryAdvanceRequest request)
        {
            var tb = new DataTable();
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SalaryAdvanceAll";
                cmd.Parameters.Add(new SqlParameter("@pageIndex", request.pageIndex));
                cmd.Parameters.Add(new SqlParameter("@pageSize", request.pageSize));
                if (request.NameSearch == null)
                {
            ...
            List<UserAdvanceSalaryViewModel> ResultList = new List<UserAdvanceSalaryViewModel>();
            for (int i = 0; i < tb.Rows.Count; i++)
            {
                UserAdvanceSalaryViewModel item = new UserAdvanceSalaryViewModel();
                item.Id = Convert.ToInt32(tb.Rows[i]["Id"]);
                item.UserId = Convert.ToInt32(tb.Rows[i]["UserId"]);
                item.FullName = tb.Rows[i]["FullName"].ToString();
                item.DepartmentName = tb.Rows[i]["DepartmentName"].ToString();
        ...
        public static List<UserPenaltyViewModel> UserPenaltyAll(PaginationUserPenaltyRequest request)
        {
            var tb = new DataTable();
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "UserPenaltyAll";
                cmd.Parameters.Add(new SqlParameter("@pageIndex", request.pageIndex));
                cmd.Parameters.Add(new SqlParameter("@pageSize", request.pageSize));
                if (request.NameSearch == null)
                {
            ...
            List<UserPenaltyViewModel> ResultList = new List<UserPenaltyViewModel>();
            for (int i = 0; i < tb.Rows.Count; i++)
            {
                UserPenaltyViewModel item = new UserPenaltyViewModel();
                item.Id = Convert.ToInt32(tb.Rows[i]["Id"]);
                item.UserId = Convert.ToInt32(tb.Rows[i]["UserId"]);
                item.FullName = tb.Rows[i]["FullName"].ToString();
                item.DepartmentName = tb.Rows[i]["DepartmentName"].ToString();
        ...
        public static List<CheckWorkingVm> CheckWorking(CheckWorkingRequest request)
        {
            ...
            using (SqlConnection con = new SqlConnection(ConnectionString.connectionString))
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "GetUserForCheckWorking";
