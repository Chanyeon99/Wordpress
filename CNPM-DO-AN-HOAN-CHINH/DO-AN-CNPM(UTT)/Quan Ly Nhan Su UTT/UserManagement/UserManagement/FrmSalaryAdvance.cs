...
namespace UserManagement
{
    public partial class FrmSalaryAdvance : Form
    {
        ...
        private void PaginationSalaryAdvance()
        {
            ...
            var result = Extendsion.SalaryAdvanceAll(request);
            ...
            var pagination = Extendsion.Pagination<UserAdvanceSalaryViewModel>(result, request);
        ...
        {
            if (txtIdUser.Text.Length == 0 || cbboxFullName.DataSource == null || txtValueAdvance.Text.Length == 0)
            {
        ...
        private void GridUserBonus_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var result = Extendsion.GetSalaryAdvanceById(int.Parse(Entity));
